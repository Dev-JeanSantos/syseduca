...
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'MATERNAL',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'PRIMEIRO PERIODO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'SEGUNDO PERIODO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'PRIMEIRO ANO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'PRIMEIRO ANO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'SEGUNDO ANO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'TERCEIRO ANO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'QUARTO ANO',4,'BIMESTRE', 'true');
INSERT INTO tb_course ( institution_id, name, duration, periodicity, status) VALUES (2,'QUINTO ANO',4,'BIMESTRE', 'true');
